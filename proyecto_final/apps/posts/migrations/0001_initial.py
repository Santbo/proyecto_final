# Generated by Django 4.2.3 on 2023-07-15 01:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(default='Sin categoría', null=True, on_delete=django.db.models.deletion.SET_NULL, to='posts.categoría')),
            ],
            options={
                'ordering': ('-publicado',),
            },
